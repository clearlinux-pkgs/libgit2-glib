...
Version  : 0.27.7
Release  : 1
URL      : https://github.com/GNOME/libgit2-glib/archive/v0.27.7.tar.gz
Source0  : https://github.com/GNOME/libgit2-glib/archive/v0.27.7.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1548349538
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --prefix /usr --buildtype=plain   builddir
ninja -v -C builddir

%install
mkdir -p %{buildroot}/usr/share/package-licenses/libgit2-glib
cp COPYING %{buildroot}/usr/share/package-licenses/libgit2-glib/COPYING
...
/usr/share/vala/vapi/ggit-1.0.deps
/usr/share/vala/vapi/ggit-1.0.vapi
...
/usr/lib64/libgit2-glib-1.0.so.0.2707.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/libgit2-glib/COPYING
