...
Source0  : https://download.gnome.org/sources/libgit2-glib/1.0/libgit2-glib-1.0.0.1.tar.xz
...
%prep
%setup -q -n libgit2-glib-1.0.0.1
cd %{_builddir}/libgit2-glib-1.0.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640275431
...
cp %{_builddir}/libgit2-glib-1.0.0.1/COPYING %{buildroot}/usr/share/package-licenses/libgit2-glib/3704f4680301a60004b20f94e0b5b8c7ff1484a9
